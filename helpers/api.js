...
var debug = require('debug')('ubersmith:api')
...
/**
 * Setup ubersmith access
 * @param {object} options
 * @return {request}
 */
exports.ubersmith = function(options){
  if(!options) options = config.ubersmith
  return setupRequest('ubersmith',options)
}
